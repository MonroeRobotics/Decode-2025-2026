...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2458.3236208776593; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1219.168221222874; // x position of the perpendicular encoder (in tick units)
    }
